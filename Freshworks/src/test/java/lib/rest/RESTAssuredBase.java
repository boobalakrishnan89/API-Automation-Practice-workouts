...
public class RESTAssuredBase extends HTMLReporter{
	...
	public static Response postWithBodyAsStringFileAndUrl(String bodyFile, String URL) {
	...
	public static Response JsonObject(String jsonObject, String URL) {
	...
	public static String getContentWithKey(Response response, String key) {
		if(response.getContentType().contains("json")) {
			JsonPath jsonPath = response.jsonPath();
			return (String) jsonPath.get(key).toString();			
		}else {
			return null;
		}
	}
